...
export function places(): QuickTarget[] {
  return [
    ...
    { id: 'go.accounts', title: 'Income & Expenses (வரவு செலவு)', hint: 'Money in, money out, balance and dues', to: '/accounts', group: 'Go to', need: 'billing', keywords: ['income', 'expense', 'expenses', 'accounts', 'account', 'varavu', 'selavu', 'cash', 'cashbook', 'balance', 'profit', 'money', 'spend', 'spent'] },
    { id: 'money.in', title: 'Record money received', hint: 'A customer paid, or other income', to: '/accounts?new=in', group: 'Do', need: 'billing', keywords: ['received', 'receipt', 'collected', 'customer', 'paid', 'payment', 'income', 'varavu', 'money', 'in'] },
    { id: 'money.out', title: 'Record money paid out', hint: 'Supplier, salary, electricity, rent…', to: '/accounts?new=out', group: 'Do', need: 'billing', keywords: ['paid', 'payment', 'expense', 'selavu', 'salary', 'wages', 'electricity', 'eb', 'rent', 'supplier', 'spent', 'money', 'out'] },
    { id: 'money.due', title: 'Who still owes us money', hint: 'Unpaid sales invoices', to: '/accounts?tab=collect', group: 'Do', need: 'billing', keywords: ['due', 'pending', 'outstanding', 'collect', 'owe', 'owes', 'balance', 'unpaid', 'credit'] },
