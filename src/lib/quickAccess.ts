...
export function places(): QuickTarget[] {
  return [
    ...
    { id: 'go.accounts', title: 'Income & Expenses', hint: 'Money in, money out, balance and dues', to: '/accounts', group: 'Go to', need: 'billing', keywords: ['income', 'expense', 'expenses', 'accounts', 'account', 'varavu', 'selavu', 'cash', 'cashbook', 'balance', 'profit', 'money', 'spend', 'spent'] },
